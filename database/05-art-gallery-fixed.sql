...
-- Artwork views tracking (FIXED - removed function call from UNIQUE constraint)
CREATE TABLE public.artwork_views (
    ...
    -- Fixed: Use view_date column instead of DATE() function
    UNIQUE(artwork_id, user_id, view_date)
);
